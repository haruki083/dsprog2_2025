...
class CalculatorApp(ft.Container):
            ...
            controls=[
                ...
                ft.Row(
                    controls=[
                        ...
                        SciButton(text="sqrt", button_clicked=self.button_clicked),
                    ]
                ),
                ft.Row(
                    controls=[
                        ...
                        SciButton(text="x^3", button_clicked=self.button_clicked),
                    ]
                ),
                ft.Row(
                    controls=[
    ...
    def button_clicked(self, e):
        ...
        # --- scientific functions ---
            ...
            rad = math.radians(float(self.result.value))
            if data == "sin":
            ...
            self.result.value = "Error" if x < 0 else self.format_number(math.sqrt(x))
            self.new_operand = True

        elif data == "log":
            x = float(self.result.value)
            self.result.value = "Error" if x <= 0 else self.format_number(math.log10(x))
            self.new_operand = True

        elif data == "ln":
            x = float(self.result.value)
            self.result.value = "Error" if x <= 0 else self.format_number(math.log(x))
            self.new_operand = True
            ...
            x = float(self.result.value)
            self.result.value = self.format_number(x ** 3)
            self.new_operand = True
